...
async function getData(slug: string): Promise<WPPost | null> {
    const res = await fetch(
        `https://wowmover.com/wp-json/wp/v2/moving-containers/?slug=${slug}`,
...
export default async function ReviewPage({
    ...
    const cons = parseList(post.acf.overall_cons || post.acf.cons);
                                        ...
                                        <div className="flex flex-col lg:flex-row gap-8">
                                            ...
                                            <div className="flex-shrink-0 flex flex-col items-center lg:items-start gap-4">
                                                <div className="w-40 h-16 relative">
                                                    {/* Assuming logo is available or using a placeholder if not in ACF */}
                                                    <Image
                                                        src="https://wowmover.com/wp-content/uploads/2022/01/u-pack-logo2.png" // Hardcoded for now as it's not in the main ACF fields shown, but usually available
