...
//     return (
//         <div className="flex flex-wrap justify-center items-center gap-2 mt-12 max-w-7xl overflow-hidden">
//             {pages.map((page, idx) =>
//                 page === '...' ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {posts.map((post) => (
                                ...
                                >
                                    {/* Featured Image */}
                                    {post.featuredImage && (
                                        <Link href={`/${post.slug}`} className="relative h-48 w-full overflow-hidden">
                                            <Image
